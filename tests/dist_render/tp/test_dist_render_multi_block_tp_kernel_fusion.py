...
class TestDistRenderMultiBlockTensorParallelKernelFusion:
    """
    Integrite test for dist_render_multi_block_tensor_parallel_kernel_fusion rendering
    """

    def setup_class(self):

        engine_cmd = "--config "
        self.conf_dir = "confs/dist_render_conf/dist_render_city_static_encodeapp.txt "
        ...
        engine_cmd += "--model_type=MultiBlockTensorParallelKernelFusion "
        ...
        EnvSetting.TENSOR_PARALLEL_SIZE = 2
