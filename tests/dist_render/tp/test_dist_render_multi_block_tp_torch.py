...
class TestDistRenderMultiBlockTensorParallelTorch:
    """
    Integrite test for dist_render_multi_block_tensor_parallel_torch rendering
    """
    ...
    def setup_class(self):
        ...
        engine_cmd += "--model_type=MultiBlockTensorParallelTorch "
