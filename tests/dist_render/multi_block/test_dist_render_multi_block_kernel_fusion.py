...
class TestDistRenderMultiBlockKernelFusion:
    """
    Integrite test for dist_render_city_multi_block_kernel_fusion
    """
    ...
    def setup_class(self):
        ...
        engine_cmd += "--use_multistream "
        engine_cmd += "--model_type=MultiBlockKernelFusion "
