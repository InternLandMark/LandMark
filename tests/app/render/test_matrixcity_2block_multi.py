...
class TestMatrixcity2BlockMulti:
    ...
    def setup_class(self):
        ...
        cmd += self.conf_dir
        cmd += "--ckpt "
        self.ckpt_dir = P_CLUSTER_CKPT_DIR + "matrix_city/matrix_city_block_1+2_multi/matrix_city_block_1+2_multi.th "
        cmd += self.ckpt_dir
        cmd += render_setting()
    ...
    def test_render(self):
        ...
        render_check(new_psnr=psnr, base_psnr=25.401024, class_name=self.__class__.__name__)
