...
class TestMatrixcity2BlockMultiChannelParallel:
    ...
    def setup_class(self):
        ...
        self.ckpt_dir = (
            P_CLUSTER_CKPT_DIR
            + "matrix_city/matrix_city_block_1+2_channel_parallel/matrix_city_block_1+2_channel_parallel-merged.th "
        )
        cmd += self.ckpt_dir
        cmd += render_setting()
    ...
    def test_render(self):
        ...
        render_check(new_psnr=psnr, base_psnr=25.653804, class_name=self.__class__.__name__)
