...
class TestMatrixcity2BlockMultiPlaneParallel:
    ...
    def setup_class(self):
        ...
        self.ckpt_dir = (
            P_CLUSTER_CKPT_DIR
            + "matrix_city/matrix_city_block_1+2_plane_parallel/matrix_city_block_1+2_plane_parallel-merged.th "
        )
        cmd += self.ckpt_dir
        cmd += render_setting()
    ...
    def test_render(self):
        ...
        render_check(new_psnr=psnr, base_psnr=25.978542, class_name=self.__class__.__name__)
